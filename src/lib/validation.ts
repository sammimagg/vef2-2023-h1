...
export function registrationValidationMiddleware(textField: string | string[] | undefined) {
  return [
    body('name')
      .trim()
      .isLength({ min: 1 })
...
export function xssSanitizationMiddleware(textField: string | string[] | undefined) {
  return [
...
export function sanitizationMiddleware(textField: string | string[] | undefined) {
  return [
